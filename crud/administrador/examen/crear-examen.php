...
if ($examenGuardadoExitosamente) {
    ...
    window.location = "editar-examen.php";
    </script>';}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <form action="crear-examen.php" class="form_examen" method="post">
        ...
        <hr class="separador">
        <p class="intrucciones-examen">Redacta las preguntas y sus respectivas respuestas.</p>
        ...
        <div id="preguntas-container">
            ...
            <div class="form_grupo form_grupo-pregunta">
                <div class="fila">
                    ...
                    <textarea  class="pregunta" type="text" name="preg1" id="preg1" ></textarea>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            agregarPreguntaBtn.addEventListener("click", function () {
                ...
                <div class="fila">
                        ...
                        <textarea class="pregunta" type="text" name="preg${numeroPregunta}" id="preg${numeroPregunta}"></textarea>
    ...
    <a  href="../assets/css/styles_crearexam.css">hola</a>
    </div>
</body>
</html>